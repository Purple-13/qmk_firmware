...
[_DVORAK] = LAYOUT(
		...
		KC_TAB, 	KC_SCLN, 	KC_Q, 		KC_J, 		KC_K, 		KC_X, 		LEQL,			/**/			RQUES,		KC_B, 		KC_M, 		KC_W, 		KC_V, 		KC_Z, 		KC_TAB,
											KC_LSFT,	KC_RALT, 	NUM_ENT, 	SYM_SPC, 		/**/		MO(_NAV_NUM), 	SYM_SPC, 	KC_LCTL, 	KC_RSFT
),
/* 																							   CHAT		
*	 ,----------------------------------------------------------------------------------.           		,-----------------------------------------------------------------------------------. 
* 	|	 Home	|	 `~ 	|	  .,	|	  P		|	  Y		|	  F		|	Esc		|       \**\ 		|	 GUI	|	 G		|	 C		|	 R		|	  L		|	 '"		|	End		|
...
* 	|    TAB	|	 ;:		|	  Q		|	  J		|	  K		|	  X		|	 =/		|       \**\		|	 ?\		|	 B		|	 M		|	 W		|	 V		|	 Z		|    TAB	|
* 	|-----------------------------------------------------------------------------------|           		|-----------------------------------------------------------------------------------|
*  				 			 			|	SHIFT	|	 ALT	|  CHAT_CLS	|	SPC		|		\**\		|  CHAT_CLS	|	SPC		|	CTRL	|	SHIFT	|	
*       							  	`-----------------------------------------------' 					`-----------------------------------------------'            
*/
[_CHAT] = LAYOUT(
		...
		KC_DEL,		KC_A, 		KC_O, 		KC_E, 		KC_U, 		KC_I, 		LBRAC,			/**/			RBRAC,		KC_D, 		KC_H, 		KC_T, 		KC_N, 		KC_S, 		KC_BSPC,
		KC_TAB, 	KC_SCLN, 	KC_Q, 		KC_J, 		KC_K, 		KC_X, 		LEQL,			/**/			RQUES,		KC_B, 		KC_M, 		KC_W, 		KC_V, 		KC_Z, 		KC_TAB,
											KC_LSFT,	KC_RALT, 	CHAT_CLS, 	KC_SPC, 		/**/		MO(_NAV_NUM), 	KC_SPC, 	KC_LCTL, 	KC_RSFT
), 	
/*																								NUM	
*	 ,----------------------------------------------------------------------------------.           		,-----------------------------------------------------------------------------------. 
